...
const GPR = {
    ...
    'mov r16,rr': {
        ...
        'f,s2a':  [ LDF, S1A_OUT_ADDR ],
        'f,s2c':  [ LDF, S1C_OUT_ADDR ],
        'f,s2d':  [ LDF, S1D_OUT_ADDR ],
        'f,s2e':  [ LDF, S1E_OUT_ADDR ],
        'f,s2s1': [ LDF, S1S2_OUT_ADDR ],
        ...
        'g,s2a':  [ LDG, S1A_OUT_ADDR ],
        'g,s2c':  [ LDG, S1C_OUT_ADDR ],
        'g,s2d':  [ LDG, S1D_OUT_ADDR ],
        'g,s2e':  [ LDG, S1E_OUT_ADDR ],
        'g,s2s1': [ LDG, S1S2_OUT_ADDR ],
        ...
        's3,s2a':  [ LDS3, S1A_OUT_ADDR ],
        's3,s2c':  [ LDS3, S1C_OUT_ADDR ],
        's3,s2d':  [ LDS3, S1D_OUT_ADDR ],
        's3,s2e':  [ LDS3, S1E_OUT_ADDR ],
        's3,s2s1': [ LDS3, S1S2_OUT_ADDR ],
        ...
        's4,s2a':  [ LDS4, S1A_OUT_ADDR ],
        's4,s2c':  [ LDS4, S1C_OUT_ADDR ],
        's4,s2d':  [ LDS4, S1D_OUT_ADDR ],
        's4,s2e':  [ LDS4, S1E_OUT_ADDR ],
        's4,s2s1': [ LDS4, S1S2_OUT_ADDR ],
        ...
        'tx,s2a':  [ LDTX, S1A_OUT_ADDR ],
        'tx,s2c':  [ LDTX, S1C_OUT_ADDR ],
        'tx,s2d':  [ LDTX, S1D_OUT_ADDR ],
        'tx,s2e':  [ LDTX, S1E_OUT_ADDR ],
        'tx,s2s1': [ LDTX, S1S2_OUT_ADDR ],
    },
    'mov r,imm': WRITE_ONLY_R,
    'mov r16,imm': WRITE_ONLY_R16,
    'mov r,(imm)': WRITE_ONLY_R,
    'mov r16,(imm)': WRITE_ONLY_R16,
    'inc r16': {
        'f':  [ INCF, NOP_OUT ],
