...
F 0 "J10" H 1118 375 50  0001 C CNN
F 1 "Conn_01x04" H 1118 466 50  0001 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 1200 800 50  0001 C CNN
...
F 0 "C10" H 1365 1646 50  0001 L CNN
F 1 "CP1" H 1365 1555 50  0001 L CNN
F 2 "Capacitor_THT:C_Radial_D6.3mm_H11.0mm_P2.50mm" H 1250 1600 50  0001 C CNN
...
F 0 "U14" V 5250 2150 50  0000 L CNN
...
F 1 "VCC" H 6000 2550 50  0000 L CNN
...
F 0 "U12" V 2950 2150 50  0000 L CNN
...
F 0 "#PWR0244" H 2800 1450 50  0001 C CNN
F 1 "VCC" V 2815 1728 50  0000 L CNN
...
F 1 "GND" H 2150 2250 50  0000 R CNN
...
F 0 "#PWR0269" H 7350 4700 50  0001 C CNN
...
F 0 "J24" H 7800 2750 50  0000 C CNN
F 1 "Conn_01x08" H 7750 2250 50  0001 C CNN
...
F 0 "J23" H 7730 1846 50  0000 L CNN
F 1 "Conn_01x08" H 7730 1801 50  0001 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x08_P2.54mm_Vertical" H 7650 1900 50  0001 C CNN
...
F 0 "J22" H 7750 1100 50  0000 L CNN
F 1 "Conn_01x05" H 7730 1001 50  0001 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x05_P2.54mm_Vertical" H 7650 1100 50  0001 C CNN
...
U 1 1 60C0FFC5
P 1900 1450
F 0 "#FLG0103" H 1900 1525 50  0001 C CNN
...
Y4
Text GLabel 7900 2800 2    50   Output ~ 0
Y5
Text GLabel 7900 2900 2    50   Output ~ 0
Y6
Text GLabel 7900 3000 2    50   Output ~ 0
Y7
Text GLabel 7900 3100 2    50   Output ~ 0
Y8
Wire Wire Line
	7850 3100 7900 3100
Wire Wire Line
...
U 1 1 60D2C138
P 1550 800
F 0 "J1" V 1468 612 50  0001 R CNN
F 1 "Screw_Terminal_01x02" V 1423 612 50  0001 R CNN
F 2 "TerminalBlock_Phoenix:TerminalBlock_Phoenix_MKDS-1,5-2_1x02_P5.00mm_Horizontal" H 1550 800 50  0001 C CNN
...
U 1 1 60D582A4
P 1100 2000
AR Path="/60CD6BAA/607C44AD/60D582A4" Ref="#PWR?"  Part="1" 
AR Path="/60E7F2E1/60D582A4" Ref="#PWR?"  Part="1" 
AR Path="/60D582A4" Ref="#PWR0101"  Part="1" 
AR Path="/60D6223D/60D582A4" Ref="#PWR?"  Part="1" 
AR Path="/617258A4/60D582A4" Ref="#PWR?"  Part="1" 
F 0 "#PWR0101" H 1100 1750 50  0001 C CNN
F 1 "GND" V 1200 2100 50  0000 R CNN
...
F 1 "VCC" V 1565 2128 50  0000 L CNN
...
Y1
Text GLabel 4050 4750 3    50   Output ~ 0
Y2
Text GLabel 3950 4750 3    50   Output ~ 0
Y3
Text GLabel 3850 4750 3    50   Output ~ 0
Y4
Text GLabel 3750 4750 3    50   Output ~ 0
Y5
Text GLabel 3650 4750 3    50   Output ~ 0
Y6
Text GLabel 3550 4750 3    50   Output ~ 0
Y7
Text GLabel 3450 4750 3    50   Output ~ 0
Y8
...
U 1 1 60E0A4DE
P 6950 4350
F 0 "BAR1" V 6904 4880 50  0000 L CNN
F 1 "HDSP-4830_2" V 6995 4880 50  0000 L CNN
F 2 "Display:HDSP-4830" H 6950 3550 50  0001 C CNN
F 3 "https://docs.broadcom.com/docs/AV02-1798EN" H 4950 4550 50  0001 C CNN
	1    6950 4350
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 60E3A0CA
P 6950 4750
F 0 "RN1" H 6470 4704 50  0000 R CNN
F 1 "R_Network08" H 6470 4795 50  0000 R CNN
F 2 "Resistor_THT:R_Array_SIP9" V 7425 4750 50  0001 C CNN
F 3 "http://www.vishay.com/docs/31509/csc.pdf" H 6950 4750 50  0001 C CNN
	1    6950 4750
	-1   0    0    1   
$EndComp
NoConn ~ 6550 4550
